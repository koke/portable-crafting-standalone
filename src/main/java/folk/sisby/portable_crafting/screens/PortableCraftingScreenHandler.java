...
public class PortableCraftingScreenHandler extends CraftingScreenHandler {
	public static final ScreenHandlerType<PortableCraftingScreenHandler> PORTABLE_CRAFTING_HANDLER_TYPE =  Registry.register(Registries.SCREEN_HANDLER_TYPE, PortableCrafting.ID, new ScreenHandlerType<>((syncId, inventory) -> new PortableCraftingScreenHandler(syncId, inventory), FeatureFlagBitSet.empty()));
